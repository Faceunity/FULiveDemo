...
美白功能主要通过参数color_level_mode2来控制

```
color_level_mode2 取值范围 0.0-1.0,0.0为无效果，1.0为最大效果，默认值0.2
```
...
参数为remove_pouch_strength_mode2
...
参数为remove_nasolabial_folds_strength_mode2
...
intensity_mouth_mode3 ：默认0.5,       //嘴巴调整程度范围0.0-1.0，0.5-0是变小，0.5-1是变大
```
