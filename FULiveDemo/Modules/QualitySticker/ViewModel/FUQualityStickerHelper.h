...
@interface FUQualityStickerHelper : NSObject
...
+ (void)itemListWithTag:(NSString *)tag
             completion:(void (^)(NSArray <FUQualityStickerModel *>* _Nullable dataArray, NSError * _Nullable error))completion;
