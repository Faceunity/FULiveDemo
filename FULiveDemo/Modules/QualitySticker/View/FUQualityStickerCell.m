...
@implementation FUQualityStickerCell
...
-(void)setModel:(FUQualityStickerModel *)model {
    _model = model;
    ...
    if ([FUQualityStickerHelper downloadStatusOfSticker:model]) {
...
- (void)setSelected:(BOOL)selected {
    if (selected) {
        ...
        self.selectedTipView.layer.borderColor = FUColorFromHex(0x1FB2FF).CGColor;
    } else {
