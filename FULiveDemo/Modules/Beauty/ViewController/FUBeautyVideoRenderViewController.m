//
//  FUBeautyVideoRenderViewController.m
//  FULiveDemo
//
...
@interface FUBeautyVideoRenderViewController ()<FUBeautyComponentDelegate>

@end

@implementation FUBeautyVideoRenderViewController
...
- (void)beautyComponentNeedsDisplayPromptContent:(NSString *)content {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [FUBeautyVideoRenderViewController cancelPreviousPerformRequestsWithTarget:self selector:@selector(dismissTipLabel) object:nil];
