Pod::Spec.new do |s|
  ...
  s.version  = '6.0.0'
  s.license  = 'MIT'
  s.summary  = 'faceunity nama v6.0.0-lite'
  s.homepage = 'https://github.com/Faceunity/FULiveDemo'
  s.author   = { 'faceunity' => 'dev_mobile@faceunity.com' }
  s.platform     = :ios, "9.0"
  s.source   = { "http": "https://www.faceunity.com/sdk/FaceUnity-SDK-iOS-v6.0.0-lite.zip"}
  s.source_files = '**/*.{h,m}'
